...
- **부스트 아이템 (v1.5)**: 코인 소모 소모품 — COIN x2(60¢, 다음 판 획득 2배) · SHIELD(80¢, DODGE 시작 실드 3회) · HEADSTART(50¢). BOOST ITEMS 패널에서 구매
- **레코드 (v1.5)**: 전체 하이스코아 TOP 8 + 평생 통계를 RECORDS 패널에서 한눈에
...
- **메타 레이어**: 코인 · 일일 미션 · 업적 7종 · 스킨 상점 · 부스트 아이템 · 레코드 패널 (v1.3~v1.5)
